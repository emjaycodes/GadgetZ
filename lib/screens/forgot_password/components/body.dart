      ...
      child: Scaffold(
        body: Column(
          ...
          Padding(
            ...
            child: Text('Enter the email address associated wth your account to reset your password.',
            style: TextStyle(
          ...
          CustomButtom(
            ...
            onPressed: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=> EmailNotifierScreen()));
            }),
