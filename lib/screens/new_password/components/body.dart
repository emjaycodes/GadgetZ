        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Your new password must be differnt from previous used passwords',
            ...
            kbigSizedbox,
                 ...
                 TextfieldName(text: 'New password',),
                 SizedBox(height: 10,),
                 // textfield
                 PasswordTextfield(),
                  kbigSizedbox,
                ...
                // sign up buttun
                CustomButtom(buttonName: 'Reset password', buttonColor: kprimaryColor, textStyle: kloginbuttonTextStyle(), onPressed: (){})
                  ],
        ),
      )
    );
